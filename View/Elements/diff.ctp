<div id="diffs">
    ...
    <div class="diff">
        <div class="title">
            <?php echo $file; ?>
            <div>
                <?php echo $this->Html->link(__('blame', true), array('action' => 'blame', base64_encode($file))); ?>
                <?php echo $this->Html->link(__('history', true), array('action' => 'commits', base64_encode($file))); ?>
            </div>
        </div>
