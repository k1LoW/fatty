<h2>
    <span><?php echo $filepath; ?> /</span> <?php echo __('Commit History'); ?> <span>(<?php echo $branch; ?>)</span>
</h2>
...
<?php echo $this->Html->link(__('Next'), array('action' => 'commit_logs', $next, base64_encode($filepath))); ?>
</div>
<?php endif; ?>