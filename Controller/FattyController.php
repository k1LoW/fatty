...
class FattyController extends FattyAppController {
    ...
    public $components = array('Fatty.Git', 'Fatty.Svn');
     ...
     * @return
     */
    public function commit_logs($page = null, $filepath = null){
        $this->layout = 'ajax';
     ...
     * @return
     */
    public function commits($filepath = null, $page = 1){
        $filepath = base64_decode($filepath);
        $limit = Configure::read('Fatty.log_limit');
        $skip = $limit * ($page - 1);
     ...
     * @return
     */
    public function diff($a = 'HEAD', $b = 'HEAD'){
     ...
     * @return
     */
    public function blame($filepath = null){
        $filepath = base64_decode($filepath);
